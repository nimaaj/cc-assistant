...
const entry = process.env.CC_ASSISTANT_MCP_ENTRY ?? "apps/mcp/dist/index.js";
...
try {
  ...
  if (!listed.structuredContent?.tasks) {
    throw new Error(`task_list did not return structured task data: ${JSON.stringify(listed)}`);
  }
  console.log(
    JSON.stringify({
